...
{
    public class TMP_SDFShaderGUIRainbowColor : TMP_BaseShaderGUI
    {
        static ShaderFeature s_OutlineFeature, s_UnderlayFeature, s_BevelFeature, s_GlowFeature, s_MaskFeature, s_RainbowFeature;

        static bool s_Face = true, s_Outline = true, s_Outline2, s_Underlay, s_Lighting, s_Glow, s_Bevel, s_Light, s_Bump, s_Env, s_Rainbow;
        ...
        static TMP_SDFShaderGUIRainbowColor()
        {
            ...
            s_RainbowFeature = new ShaderFeature()
            {
                undoLabel = "Rainbow",
                keywords = new[] { "RAINBOW_ON" }
            };
        ...
        protected override void DoGUI()
        {
            ...
            s_Rainbow = BeginPanel("Rainbow", s_RainbowFeature, s_Rainbow);
            if (s_Rainbow)
            {
                DoRainbowPanel();
            }
        ...
        static GUIContent[] s_RainbowDirectionLabels =
        {
            new GUIContent("Left to Right"),
            new GUIContent("Right to Left")
        };

        void DoRainbowPanel()
        {
            EditorGUILayout.Space();
            DoTexture2D("_RainbowTex", "Rainbow Texture");
            DoSlider("_RainbowStrength", "Rainbow Strength");
            DoSlider("_RainbowSpeed", "Rainbow Speed");
            DoFloat("_RainbowScale", "Rainbow Scale");
            DoPopup("_RainbowFlowDirection", "RainbowDirection", s_RainbowDirectionLabels);
        }
